...
# 
# ![alt text](../images/Box-Plot-and-Whisker-Plot-1.png)
...
# Στην τρέχουσα ενότητα παρουσιάζεται η δημιουργία ενός διαγράμματος διασποράς με την χρήση οικομομικών δεδομένων από την Ελληνική στατιστική υπηρεσία (ΕΛ.ΣΤΑΤ.).
